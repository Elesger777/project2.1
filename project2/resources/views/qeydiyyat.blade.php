               ...
               <div class="login_section">
                  ...
                  <div class="login_form">
                     <form method="post" action="{{route('daxilet')}}">
                        ...
                        <fieldset>
                           <div class="field">
                              <label class="label_field">Ad</label>
                              <input type="text" name="ad" placeholder="Adinizi daxil edin" />
                           </div>
                           <div class="field">
                              <label class="label_field">Soyad</label>
                              <input type="text" name="soyad" placeholder="Soyadinizi daxil edin" />
                           </div>
                           <div class="field">
                              <label class="label_field">Email</label>
                              <input type="email" name="email" placeholder="Email adresini daxil edin" />
                           </div>
                           <div class="field">
                           ...
                           <div class="field">
                              ...
                              <label class="form-check-label"><input type="checkbox" class="form-check-input"> Remember Me</label><br>
                              <a class="forgot" href="{{route('login')}}">Login</a>
                           </div>
                           <div class="field margin_0">
                              <label class="label_field hidden">hidden label</label>
                              <button type="submit" class="main_bt">Daxil edin</button>
                           </div>
                        </fieldset>
                     </form>
                  </div>
